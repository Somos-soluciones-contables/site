...
function normalizeColor(hexCode) {
  ...
  class Gradient {
    constructor(...t) {
      ...
      e(this, "frame", 0); // Added frame counter
      ...
      e(this, "animate", e => {
        ...
        this.frame += 1; // Increment frame counter
    ...
    shouldSkipFrame(e) {
      return !!window.document.hidden || (!this.conf.playing || (this.frame % 2 == 0 || void 0)); // Updated to use frame counter
    }
